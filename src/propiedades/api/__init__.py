...
def registrar_handlers():
    import propiedades.modulos.propiedades.aplicacion

def importar_modelos_alchemy():
    import propiedades.modulos.propiedades.infraestructura.dto
...
def comenzar_consumidor(app):
    ...
    import threading
    import propiedades.modulos.propiedades.infraestructura.consumidores as propiedades
    ...
    threading.Thread(target=propiedades.suscribirse_a_comandos_eliminar, args=(app,)).start()
