...
def registrar_handlers():
    import sagas.modulos.sagas.aplicacion

def importar_modelos_alchemy():
    import sagas.modulos.sagas.infraestructura.dto
...
def comenzar_consumidor(app):
    ...
    import threading
    import sagas.modulos.sagas.infraestructura.consumidores as sagas
    import sagas.modulos.sagas.infraestructura.consumidores_evento_saga as trans
    ...
    # Suscripción a comandos
    threading.Thread(target=trans.suscribirse_a_inquilino_creado, args=(app,)).start()

    # Suscripción a comandos
    threading.Thread(target=trans.suscribirse_a_propiedad_creada, args=(app,)).start()
