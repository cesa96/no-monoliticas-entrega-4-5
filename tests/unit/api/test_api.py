...
from clientes.api import create_app, importar_modelos_alchemy
from clientes.config.db import init_db
...
def test_clienter_vuelo(client):
    rv = client.post('/vuelos/cliente', data=json.dumps(cliente_correcta()), content_type='application/json')
